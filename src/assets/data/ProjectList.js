...
//Icons
import { SiTailwindcss, SiMysql, SiSwagger, SiTypescript, SiJest } from "react-icons/si";
...
// import lendOverview from "../pictures/LendService/lendOverview.png";
// import lendMap from "../pictures/LendService/lendMap.png";

const projectList = [
  <DefaultProject
    name={"Lending Service"}
    // imageFront={lendMap}
    // imageBack={lendOverview}
    githubLink={"https://github.com/calculusky/fictional-lending-api"}
    liveVersionLink={"https://fictional-fund-api.herokuapp.com/api/api-docs"}
    hasLoginCredentials={false}
    projectShortDescription={<Text tid="lendSubheading" />}
    aboutProjectText={
      <div>
        <Text tid="aboutArb1" />
        <br /> <br />
    ...
    techStack={[
      ...
      {
        name: "TypeScript",
        logo: <SiTypescript className="w-12 h-12" style={{ color: "#2d79c7" }} />,
        subtexts: ["4.5.5"],
      },
      {
        name: "Knex",
        logo: <img className="w-22 h-12" src={knexLogo} alt="Knex" />,
        subtexts: ["1.0.3"],
      },
      {
        name: "MySQL",
        logo: <SiMysql className="w-12 h-12" style={{ color: "#38b2ac" }} />,
        subtexts: ["8.0"],
      },
      {
        name: "Swagger",
        logo: <SiSwagger className="w-12 h-12" style={{ color: "#85ea2d" }} />,
        subtexts: ["2.0"],
      },
      {
        name: "Jest",
        logo: <SiJest className="w-12 h-12" style={{ color: "#9c445c" }} />,
        subtexts: ["27.5.1"],
      },
    ]}
  />,
